...
// 稿件类型
export const manuscriptTypes = createRequestTypes('manuscript');
export const manuscript = {
    request: (opt) => action(manuscriptTypes[REQUEST], opt),
    success: (opt, response) => action(manuscriptTypes[SUCCESS], {opt, response}),
    failure: (opt, error) => action(manuscriptTypes[FAILURE], {opt, error}),
};