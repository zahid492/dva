...
d3.charts.sparkline = function () {
    ...
    my.chart = function () {
        var xDomain = d3.extent(lines, function (d) {
            return d.x
        });
        var yDomain = d3.extent(lines, function (d) {
            return d.y
        });
        x
            .domain(xDomain)
            .range([
                0, my.chartWidth(my.w(), margin)
            ]);
        y
            .domain(yDomain)
            .range([
                0, my.chartHeight(my.h(), margin)
            ]);
