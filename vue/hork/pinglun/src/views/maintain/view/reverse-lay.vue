<template>
    <!--http://localhost:8081/#/sub/view-reverse/50-->
    <view-lay
            :type="'反向'"
            :who="who"
            :jietu="true"
    ...
    >
        ...
        <template #require-see="{its}">
            ...
            <div class="require-list">
                ...
                <div class="item"><span>反向数：</span>{{its.cmt.count}}条</div>
        ...
        <template #content-see="{its}">
            ...
            <div class="see-pinglun">
                <div class="pinglun-item">
                    <span class="num"> {{its.index+1}}、</span>
                    <div class="text">{{its.cmt.comment}}</div>
                </div>
            </div>
        </template>
        ...
        <template #require-see-more="{its}">
            ...
            <div class="require-list">
                ...
                <div class="item"><span>反向数：</span>{{its.cmt.count}}条</div>
                <div class="item"><span>要求完成时间：</span>{{its.item.finisheddt}}</div>
            </div>
        </template>
