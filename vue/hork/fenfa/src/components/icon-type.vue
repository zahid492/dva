<template>
    <div>
        <img v-if="id==='句子对'" src="@/assets/rw-icon1.png" alt="">
        <!--同义词-->
        <img v-if="id==='同义词'" src="@/assets/rw-icon3.png" alt="">
        <!--审核任务-->
        <img v-if="id==='审核'" src="@/assets/rw-icon2.png" alt="">
        <!--评价任务-->
        <img v-if="id==='评价'" src="@/assets/rw-icon4.png" alt=""/>
