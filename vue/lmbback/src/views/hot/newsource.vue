    ...
    <div>
        ...
        >
            <el-form ref="addForm"
                ...
                <el-form-item label="链接：" porp="link">
                    <el-input
                            style="width:300px"
                            v-model="form.link"
                            placeholder=""></el-input>
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                rules: {
                    ...
                    weiboID: [
                        {required: true, message: '请输入微博ID', trigger: 'blur'},
        ...
        methods: {
            ...
            search: function () {
                ...
                service({
                    method: "get",
                    url: Api.hotnews_MediaAccount_list,
            ...
            addAjaxItem() {
                this.$refs["addForm"].validate((valid) => {
                    if (valid) {
                        ...
                        if (this.isEdit) {
                            url = Api.hotnews_MediaAccount_put;
                        } else {
                            url = Api.hotnews_MediaAccount_add;
                        }
                        service({
                            method: "post",
                            url: url,
            ...
            deleteItem: function (record) {
                ...
                this.$confirm("确认要删除该项吗？", "提示", {
                    ...
                    service({
                        method: "post",
                        url: Api.hotnews_MediaAccount_del,
                        data: '"' + record._id + '"'
                    }).then(function () {
                        that.$message({
                            type: "success",
