                ...
                <div id="sentence_search">
                    <el-form ref="form" :inline="true"
                        ...
                        <el-form-item label="统计方式：" label-width="50">
                            <el-radio-group v-model="DateTimeType"
                        ...
                        <el-form-item label="时间：" label-width="50">
                            ...
                            <el-date-picker
                                    style="width:280px"
                                    size="small"
                                    clear-icon="mclear-icon"
                                    :clearable="false"
                                    :type="DateTimeType===1?'monthrange':'datetimerange'"
    ...
    export default {
        ...
        methods: {
            changeDateType(v) {
                this.dateRange = [];
                if (v === 0) {
                    this.formatUI="yyyy-MM-dd";
                    this.formatValue = "yyyyMMdd";
                } else {
                    this.formatUI="yyyy-MM";
                    this.formatValue = "yyyyMM";
                }
