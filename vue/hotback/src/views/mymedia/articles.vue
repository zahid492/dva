                ...
                >
                    ...
                    >
                        <template slot-scope="scope">
                            <el-tooltip placement="top" v-if="!scope.row.normal">
                                <div slot="content">{{scope.row.officalMessage}}</div>
                    ...
                    >
                        <template slot-scope="scope">
                            <el-button type="primary" size="mini" @click.pervent="view(scope.row)">查看</el-button>
                        </template>
                    </el-table-column>
...
<script>
    ...
    export default {
        ...
        watch: {
            ...
            //     if (this.dateRange && this.dateRange[1] && this.dateRange[0]) {
            //         let m1year = this.dateRange[1].split("-")[0];
            //         let m0year = this.dateRange[0].split("-")[0];
            //         let m1month = this.dateRange[1].split("-")[1];
            //         let m0month = this.dateRange[0].split("-")[1];
            //
            //         if (m1year !== m0year) {
            //             this.DateTimeType = 1;
            //         }else if (m1month !== m0month) {
            //             this.DateTimeType = 1;
            //         }else {
            //             this.DateTimeType = 0;
            //         }
        ...
        methods: {
            ...
            // 查看
            view: function (row) {
                let url = host_media + "/edit/" + row._id;
            ...
            exportTaskExcel: function () {
                ...
                let url = Api.mymedia_article_export + "?" + qs;
