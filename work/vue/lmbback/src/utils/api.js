//全局变量，接口     baseURL: config.apiPath,
export const Api = {
    //热点
    ...
    statistics_article: "api/Statistics/getstatisticsarticle",
    ...
    mymedia_account_yiche: 'api/MiaobiAccount/PublishYicheVideo',
    mymedia_account_aika: 'api/MiaobiAccount/PublishAikaVideo',
    yiche_tag:'api/Dictionaries/YicheTag',
    yiche_car:'api/Dictionaries/YicheRelationCar',
    ...
    yicheUpPoster: 'api/MiaobiAccount/UploadCoverImage',
    yicheUpVideo: 'api/MiaobiAccount/UploadVideo',
...
export const userApi = {
    // 平台登录接口，刷新
    mymedia_auth_list: 'api/User/authList',
};

export const picApi = "http://191.167.20.217:1005";
