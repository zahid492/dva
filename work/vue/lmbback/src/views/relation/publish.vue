    ...
    <div>
                ...
                >
                    ...
                    >
                        <template slot-scope="scope">
                            {{scope.row.hotTopicTypes ? scope.row.hotTopicTypes.join(", "):""}}
                        </template>
                    </el-table-column>
        ...
        >
            <el-form ref="addForm"
                ...
                <el-form-item label="文章分类：" prop="hotTopicTypes"
                >
                    <el-select v-model="form.hotTopicTypes"
                               placeholder="请选择"
                               size="small"
                               multiple
                               style="width:500px"
...
<script>
    ...
    export default {
        ...
        data: function () {
            const validTopic = (rule, value, callback) => {
                if (value.length === 0) {
            ...
            return {
                ...
                rules: {
                    ...
                    hotTopicTypes: [
                        {trigger: 'blur', validator: validTopic},
                    ]
                },
        ...
        methods: {
            ...
            deleteItem: function (record) {
                ...
                this.$confirm("确认要删除该项吗？", "提示", {
                    ...
                    service({
                        method: "post",
                        url: Api.relation_publish_delete,
                        data: '"' + record._id + '"'
                    }).then(function () {
                        that.search();
                        that.$message({
            ...
            getArticleType() {
                service({
                    ...
                    this.articleTypeList = res.data.map(v => {
                        v.addDateTimeV = moment(v.addDateTime).format("YYYY-MM-DD HH:mm:ss");
                        return v;
                    });
                })
