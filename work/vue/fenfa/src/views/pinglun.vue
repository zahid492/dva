  ...
  <div class="jz-box pingjia-box">
    ...
    <div class="zxjz-box">
      <div class="home-title2">
        新闻参考
        <span class="fr chakan">
          查看详情
          <span class="icon-right iconfont"></span>
        </span>
      </div>
      <div class="yuanju-text">李彦宏的2019两会提案：完善电子病历，解决老百姓看病难的问题</div>
    </div>
    ...
    <div class="pinglun-box">
      <div class="yuanju-text gaixie-text pinglun-text">
        <van-cell-group>
          <van-field v-model="childSentence" type="textarea" placeholder="在此输入10-15字的评论" rows="7" />
        </van-cell-group>
      </div>
    ...
    <div class="btn-box">
      ...
      <button class="next" :disabled="sub" @click="getNext" v-if="!isLast">下一个</button>
    </div>
