...
$(function () {
    ...
    getEventDetail({"id": id, "name": name}).then(function (ed) {
        ...
        var xdata = _.map(_.toPairs(ed.NewsCountByDayList), function (v) {
            ...
            // console.log(v)
            // v[0] = v[0].substring(4, 6)+"." + v[0].substring(6, 8);
        ...
        var lopt = {
            ...
            tooltip: {
                ...
                // formatter: "2017.{b}<br />{c}",
                formatter: function(params, ticket){
                    // console.log(params, ticket)
                    var year = params[0].axisValue.substring(0, 4);
                    var month = params[0].axisValue.substring(4,6);
                    var day = params[0].axisValue.substring(6,8);

                    return '<b>' + params[0].axisValue + '<br/>'+ params[0].value + '</b>';
                },
                textStyle: {
                    fontSize: 12
                }
